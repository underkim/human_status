...
class GoalsListView extends ConsumerWidget {
  ...
  Future<void> _completeGoal(BuildContext context, WidgetRef ref, Goal goal) async {
    ...
    messenger.showSnackBar(SnackBar(content: Text('"${goal.title}" 목표를 달성했어요!')));
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final active = [...ref.watch(activeGoalsProvider)]..sort((a, b) {
    ...
    return ListView(
      ...
      children: [
        ...
        if (completed.isNotEmpty) ...[
          ...
          const SizedBox(height: AppSpacing.sm),
          ...completed.map((g) => GoalProgressCard(
                title: g.title,
                description: g.description.isNotEmpty ? g.description : null,
                progress: 1,
                trailingInfo: g.targetAmount != null
